...
class HalfSangum extends React.Component {
    constructor(props){
        super()
        this.state = {
        ...
        return(
            ...
            { this.state.activeBid && 
                <BidInputWithMutation 
                    ...
                    bid_type='Half-Sangum'
            />}
            <Box gridArea="main" background="light-1" >
                <Box pad={{horizontal:"small"}}><Heading level="2">Half Sangum</Heading></Box>
                <Box
...
export default graphql(getAllBazaars)(HalfSangum)
