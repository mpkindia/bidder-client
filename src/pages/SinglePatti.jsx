...
class SinglePatti extends React.Component {
    constructor(props){
        super()
        this.state = {
        ...
        return(
            ...
            { this.state.activeBid && 
                <BidInputWithMutation 
                    ...
                    bid_type='Single-Patti'
            />}
            <Box gridArea="main" background="light-1" >
                <Box pad={{horizontal:"small"}}><Heading level="2">Single Patti</Heading></Box>
                <Box
...
export default graphql(getAllBazaars)(SinglePatti)
