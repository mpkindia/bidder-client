...
class TriplePatti extends React.Component {
    constructor(props){
        super()
        this.state = {
        ...
        return(
            ...
            { this.state.activeBid && 
                <BidInputWithMutation 
                    ...
                    bid_type='Triple-Patti'
            />}
            <Box gridArea="main" background="light-1" >
                <Box pad={{horizontal:"small"}}><Heading level="2">Triple Patti</Heading></Box>
                <Box
...
export default graphql(getAllBazaars)(TriplePatti)
